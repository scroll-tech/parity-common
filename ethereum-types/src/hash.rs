...
mod tests {
	...
	#[cfg(feature = "rkyv")]
	test_transmute_rkyv!(H32);

	#[cfg(feature = "rkyv")]
	test_transmute_rkyv!(H64);

	#[cfg(feature = "rkyv")]
	test_transmute_rkyv!(H264);

	#[cfg(feature = "rkyv")]
	test_transmute_rkyv!(H520);
}
